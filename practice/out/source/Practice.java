/* autogenerated by Processing revision 1286 on 2022-09-07 */
...
int[] style;
 ...
 public void setup() {
  ...
  for (int i = 0; i < COUNT; i++) {
    ...
    pt[index++] = PApplet.parseInt(random(2,50)*5); // Radius. Space them out nicely
...
// Draw arc line
 public void arcLine(float x, float y, float degrees, float radius, float w) {
...
// Draw arc line with bars
 public void arcLineBars(float x, float y, float degrees, float radius, float w) {
  beginShape(QUADS);
...
// Draw solid arc
 public void arc(float x, float y, float degrees, float radius, float w) {
