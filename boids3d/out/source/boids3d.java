...
// agent variables
float agentHBRad = 1.5f*kiwiScale;
int numAgents = 1;
 ...
 public void start() {
    ...
    for (int id = 0; id < numAgents; id++) {
        ...
        agentPos[id] = new Vec3(
            (-sceneX*0.5f)+(wallPadding+agentHBRad)+random(2*((sceneX*0.5f)-(2*wallPadding)-agentHBRad)),
            -0.71f*kiwiScale,
            (-sceneZ*0.5f)+(wallPadding+agentHBRad)+random(2*((sceneZ*0.5f)-(2*wallPadding)-agentHBRad))
        );
