...
public class Boids2D extends PApplet {
 ...
 public void draw(){
  ...
  for (int i = 0; i < numBoids; i++){
    ...
    for  (int j = 0; j < numBoids; j++){ //Go through neighbors
      ...
      if (dist < .01f || dist > 50) continue; //TODO: Why do we not need to skip i == j?
      Vec2 seperationForce =  pos[i].minus(pos[j]).normalized();
      seperationForce.setToLength(200.0f/pow(dist,2));
    ...
    avgPos.mul(1.0f/count);
    if (count >= 1){
      Vec2 attractionForce = avgPos.minus(pos[i]);
      attractionForce.normalize();
      attractionForce.mul(1.0f);
...
public class Vec2 {
 ...
 public Vec2 projAB(Vec2 a, Vec2 b){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Boids2D" };
    if (passedArgs != null) {
