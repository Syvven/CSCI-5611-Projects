...
float circleRad[] = new float[numObstacles];  //Circle radii
 ...
 public void setup(){
  ...
  for (i = 0; i < numAgents/2; i+=2) {
    agentPos[i] = new Vec2((i+3.5f)*numw,20);
    goalPos[i] = new Vec2((i+3.5f)*numw,height-70);

    agentPos[i+1] = new Vec2((i+3.5f)*numw,height-20);
    goalPos[i+1] = new Vec2((i+3.5f)*numw,70);
  }

  for (i = 0; i < numAgents/2; i+=2) {
    agentPos[i+(numAgents/2)] = new Vec2(20,(i+3.5f)*numh);
    goalPos[i+(numAgents/2)] = new Vec2(width-70,(i+3.5f)*numh);

    agentPos[i+(numAgents/2)+1] = new Vec2(width-20,(i+3.5f)*numh);
    goalPos[i+(numAgents/2)+1] = new Vec2(70,(i+3.5f)*numh);
  }
