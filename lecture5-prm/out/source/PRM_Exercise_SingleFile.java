...
public class PRM_Exercise_SingleFile extends PApplet {
...
//Returns true if the point is inside a box
 public boolean pointInBoxList(ArrayList<Vec2> boxes, float boxW, float boxH, Vec2 pointPos){
...
class hitInfo{
 ...
 public hitInfo rayBoxListIntersect(ArrayList<Vec2> boxes, float boxW, float boxH, Vec2 ray_start, Vec2 ray_dir, float max_t) {
  hitInfo hit = new hitInfo();
  hit.t = max_t;
  for (Vec2 boxTopLeft : boxes) {
...
//Generate non-colliding PRM nodes
 public void generateRandomNodes(Vec2[] circleCenters, float[] circleRadii, ArrayList<Vec2> boxes, float boxW, float boxH){
  for (int i = 0; i < numNodes; i++){
...
// 2. Connect mutually visible nodes as graph neighbors
 public void buildPRM(Vec2[] circleCenters, float[] circleRadii, ArrayList<Vec2> boxes, float boxW, float boxH){
...
public class Vec2 {
 ...
 public Vec2 projAB(Vec2 a, Vec2 b){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "PRM_Exercise_SingleFile" };
    if (passedArgs != null) {
