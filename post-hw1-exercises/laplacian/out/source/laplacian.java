/* autogenerated by Processing revision 1286 on 2022-10-05 */
...
public class laplacian extends PApplet {
...
//TODO: Change me to a blackbody color ramp
 public void colorByTemp(float u){
  if (u <= 0) {
    u = 0.001f;
  } else if (u >= 1) {
    u = 0.999f;
  ...
  if (0 < u && u <= 0.333f) {
     ...
     g = 0;
     b = 0;
  } else if (0.333f < u && u <= 0.666f) {
    r = 255;
    g = 255*u*(1/0.666f);
    b = 0;
  } else if (0.666f < u && u <= 0.999f) {
    r = 255;
    g = 255;
    b = u*255;
  }
...
boolean paused = true;
 ...
 public float interpolate(float a, float b, float t){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "laplacian" };
    if (passedArgs != null) {
