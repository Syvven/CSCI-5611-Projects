...
void generateRandomNodes(Vec2[] circleCenters, float[] circleRadii){
  for (int i = 0; i < numNodes; i++){
...
void buildPRM(Vec2[] circleCenters, float[] circleRadii){
